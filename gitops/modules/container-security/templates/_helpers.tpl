...
{{ include "container-security.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "container-security.selectorLabels" -}}
...
*/}}
{{- define "container-security.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "container-security.fullname" .) .Values.serviceAccount.name }}
{{- else }}
