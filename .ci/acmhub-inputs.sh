...
export TF_VAR_cluster_name="acmhub-lbarry01" # Max str length 15 characters
...
export TF_VAR_master_subnet_cidr="10.3.90.0/24"  # Use /24 or larger
export TF_VAR_worker_subnet_cidr="10.4.90.0/24"  # Use /24 or larger
