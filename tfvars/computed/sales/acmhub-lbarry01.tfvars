...
vpc="acmhub-lbarry01-vpc"

master_subnet_name="acmhub-lbarry01-master-subnet"

master_subnet_cidr="10.3.90.0/24"

master_subnet_id="6067326149833422621"

worker_subnet_name="acmhub-lbarry01-worker-subnet"

worker_subnet_cidr="10.4.90.0/24"

worker_subnet_id="3239341664342538013"
...
cluster_details_secret_name="openshift-dev-acmhub-lbarry01-cluster-details"
...
custom_dns_domain_prefix="acmhub-lbarry01.dev.us-central1.sales"

custom_dns_domain_name="acmhub-lbarry01.dev.us-central1.sales.openshift.example.com"

acmhub_cluster_env="dev"

cluster_infra_tags={"cluster_name"="acmhub-lbarry01","cluster_type"="osd-gcp","cost_center"="570633","created_by"="lbarry_redhat-com","environment"="dev","organization"="sales","team_owner"="platform-ops"}
